 <footer class="footer-area section-padding-100" style="background-color: #4cc0cb !important;">
        <!-- Main Footer Area -->
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="footer-widget-area">
                            ...
                            <div class="footer-social-info">
                                ...
                                <a href="https://www.facebook.com/Hospital.Raaj/" target="new"><i class="fa fa-facebook" aria-hidden="true"></i></a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Raaj Hospital developed by <a href="https://accentelsoft.com/" target="_blank" style="color:#006cff !important">Accentel Software Solutions Pvt.ltd</a>
