...
if(isset($_POST['sublll'])){
	...
	$sq=mysqli_query($link,"insert into home_gallery(image,desc1)values('$iname1','$desc1')");
	if($sq){
	print "<script>";
...
if(isset($_POST['update'])){
  ...
  $id=$_POST['id'];
	...
	$sq=mysqli_query($link,"update  home_gallery set image='$iname1',desc1='$desc1' where id='$id'");
	if($sq){
	print "<script>";
		...
		print "<script>";
			print "alert('Unable To Save');";
			print "self.location='home_gallery_edit.php?id=$id';";
			print "</script>";
