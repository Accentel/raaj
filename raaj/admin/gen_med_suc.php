...
if(isset($_POST['update'])){
  ...
  $id=$_POST['id'];
	...
	$sq=mysqli_query($link,"update  gen_med_desc set image='$iname1',desc1='$desc1' where id='$id'");
	if($sq){
	print "<script>";
			print "alert('Sucessfully Updated');";
			print "self.location='gen_med.php';";
			print "</script>";
	} else {
		print "<script>";
			print "alert('Unable To Save');";
			print "self.location='gen_med_edit.php?id=$id';";
			print "</script>";
