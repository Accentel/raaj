...
if(isset($_POST['update'])){
  ...
  $id=$_POST['id'];
	...
	$sq=mysqli_query($link,"update  rajshri set image='$iname1',desc1='$desc1' where id='$id'");
	if($sq){
	print "<script>";
			print "alert('Sucessfully Updated');";
			print "self.location='rajshri_soni1.php';";
			print "</script>";
	} else {
		print "<script>";
			print "alert('Unable To Save');";
			print "self.location='rajshri_soni_edit.php?id=$id';";
			print "</script>";
