...
if(isset($_POST['update'])){
  ...
  $id=$_POST['id'];
	...
	$sq=mysqli_query($link,"update  general_desc set image='$iname1',desc1='$desc1' where id='$id'");
	if($sq){
	print "<script>";
			print "alert('Sucessfully Updated');";
			print "self.location='general.php';";
			print "</script>";
	} else {
		print "<script>";
			print "alert('Unable To Save');";
			print "self.location='general_edit.php?id=$id';";
			print "</script>";
