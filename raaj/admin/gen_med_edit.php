<?php include("header.php");?>
				<!-- end: sidebar -->
<?php $id=$_REQUEST['id'];
	 $a="select * from gen_med_desc where id='$id'";
							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" name="frm" method="post" enctype="multipart/form-data" action="gen_med_suc.php">
