...
date_default_timezone_set('Asia/Kolkata');
 $ndate=date( 'Y-m-d H:i:s', time ()); 
  ...
  $date = DateTime::createFromFormat("Y-m-d", $bdate);
	...
	$dxx1=date($y.'-01-01');
$d2=date($y.'-12-31');
$aa="select count(1) as ct from physiotherapybill where bdate = '$bdate' ";
...
$bno="BL-".$d.$m.$y."-".$reg;
	...
	if($mrno != '') {
		$ts="INSERT INTO physiotherapybill(mrno,billno,bdate,pname,age,gender,dname,mobile,ptype,time,tamount,discount,namount,pamount,bamount,remarks,user,paymenttype,ndays)VALUES
		('$mrno','$bno','$bdate','$pname','$age','$gender','$dname','$mobile','$ptype','$time','$tamount','$discount','$namount','$pamount','$balamount','$remarks','$user','$paymenttype','$ndays')";
