...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add Asthama and Allergy Report</title>
...
<table width="100%" cellpadding="0" cellspacing="0"> 
    ...
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header"> Asthama and Allergy List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
                    ...
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                        ...
                        <tr>
                            ...
                            <td align="center"><b>Date</b></td>
							 <td align="center"><b>Affected Since</b></td>
							  <td align="center"><b>Other Complains</b></td>
                       
							  <td align="center"><b>Other Medications</b></td>
                     ...
                     if($uid!=''){
						$qry=mysqli_query($link,"SELECT * FROM `asthama` where   pname='$uid'");
					 }else {
						$qry=mysqli_query($link,"SELECT * FROM `asthama` ");
					 }
						if($qry){
						$i=0;
                        ...
                        <tr>
                            <td align="center"><?php echo $i ?></td>
                              ...
                              <td align="center"><?php echo $res['pname']; ?></td>
                            <td align="center"><?php echo $res['mobile']; ?></td>
                            <td align="center"><?php echo $age."/".$sex ?></td>
                          
                               <td align="center"><?php echo $date ?></td>
                           
                           <td align="center"><?php echo $res['affected']; ?></td>
						    <td align="center"><?php echo $res['oth_comp']; ?></td>
							 <td align="center"><?php echo $res['oth_med']; ?></td>
