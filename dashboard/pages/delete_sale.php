...
include("../db/connection.php");
	$id=$_GET['id'];
	 ...
	 $sq=mysqli_query($link,"select * from phr_salent_mast where lr_no='$id'");
...
`mobileno`='',`address1`='',`mrnum`='',`spl_dis`='',`bal`='',`sr_bill_num`='',status='Delete' where lr_no='$id'");

$b="delete FROM daily_amount where  bill_num='$sr_bill_num'";
