...
$lr_id=$_REQUEST['id'];
$sql = mysqli_query($link,"select a.suppl_code,b.suppl_name,b.addr1,pur_type,suppl_inv_no,inv_date,rec_by,total,rec_date,grn,b.city,lr_no,b.paid,b.bal from phr_purinv_mast as a,phr_supplier_mast as b where lr_no='$lr_id' and a.suppl_code=b.suppl_code");
if($sql){
...
function calkdyn(i)
{
	var sqty1=document.getElementById('sqty'+i).value ;
	//alert(sqty1);
	var noi1=document.getElementById('noi'+i).value ;
	document.getElementById('tqty'+i).value =sqty1*noi1;
...
{
    alert(i);
	var sqty1=document.getElementById('srate'+i).value ;

	var no=document.getElementById('noi'+i).value ;
	var noi1=document.getElementById('sqty'+i).value ;
	var tqty=document.getElementById('tqty'+i).value;
	var sfree=document.getElementById('sfree'+i).value;
	var mrpo=document.getElementById('mrp'+i).value;
...
//	alert(sf3);
	...
	vat=vatamt/2;
		//alert(vatamt);
	alert(vat);
	document.getElementById('sal_tab'+i).value =p1;
	document.getElementById('value'+i).value =p;
//	document.getElementById('sal_ftab'+i).value =sf3;
		document.getElementById('mrp_tab'+i).value =emrp;
	document.getElementById('sgst'+i).value =vat;
	document.getElementById('cgst'+i).value =vat;
	document.getElementById('vatamt'+i).value =vatamt;
...
function mrp(i)
{
	var sqty1=document.getElementById('mrp'+i).value ;
	//alert(sqty1);
	var noi1=document.getElementById('noi'+i).value ;
	var t=eval(sqty1)/noi1
	document.getElementById('mrp_tab'+i).value =t;
...
//document.getElementById('discad').value=grandTotal2;
	...
	document.getElementById('vatadd').value=grandTotal1;
		...
		document.getElementById('gtot').value=grandTotal+grandTotal1;
			document.getElementById('bal').value=grandTotal+grandTotal1;
   ...
   <th width="5%" class="TH1">SGST</th>
    <th width="5%" class="TH1">CGST</th>
     <th width="6%" class="TH1">GST</th>
		...
		<td class="TD1"><input type="text" class="form-control" name="pname[]" value="<?php echo $pname ?>" id="pname<?php echo $ijkc?>" size="10"/></td>
		<!--<td class="TD1"><?php// echo $packing ?></td>-->
		<td class="TD1"><input type="text" class="form-control" name="maniby[]" value="<?php echo $maniby ?>" id="maniby<?php echo $ijkc?>" size="10"/></td>
		    <td class="TD1"><input type="text" class="form-control" name="batch[]" value="<?php echo $batch ?>" id="batch<?php echo $ijkc?>" size="8"/></td>
				<td class="TD1"><input type="text" class="form-control" name="mfgdate[]" value="<?php echo $mfgdt ?>" id="mfgdate<?php echo $ijkc?>" size="10"/></td>
					<td class="TD1"><input type="text" class="form-control" name="expdate[]" value="<?php echo $expdt ?>" id="expdate<?php echo $ijkc?>" size="10"/></td>
		<td class="TD1"><input type="text" class="form-control" name="noi[]" value="<?php echo $noi ?>" id="noi<?php echo $ijkc?>" size="4"/></td>
		...
		<td class="TD1"><input type="text" class="form-control" name="sqty[]" value="<?php echo $sqty ?>" id="sqty<?php echo $ijkc?>" onKeyup="calkdyn(<?php echo $ijkc?>)" onfocus="calkdyn(<?php echo $ijkc?>)" size="4" /></td>
		<td class="TD1"><input type="text" class="form-control" name="tqty[]" value="<?php echo $tqty ?>" id="tqty<?php echo $ijkc?>" size="4" /></td>
		
        <td class="TD1"><input type="text" class="form-control" name="sfree[]" value="<?php echo $sfree ?>" id="sfree<?php echo $ijkc?>" size="4"/></td>
		 <td class="TD1"><input type="text" class="form-control" name="srate[]" value="<?php echo $srate ?>" id="srate<?php echo $ijkc?>" size="6" onKeyup="calkdyn1(<?php echo $ijkc?>)"/></td>
		
 <td class="TD1"><input type="text" class="form-control" name="sal_tab[]" value="<?php echo $each_pur_rate ?>" id="sal_tab<?php echo $ijkc?>" size="6" onChange="calcTotals()"/></td>
 
		 
        <td class="TD1"><input type="text" class="form-control txt" name="value[]" value="<?php echo $valu ?>" id="value<?php echo $ijkc?>" size="6"/></td>
		<td class="TD1"><input type="text" class="form-control" name="mrp[]" value="<?php echo $mrp ?>" id="mrp<?php echo $ijkc?>"  onKeyup="mrp(<?php echo $ijkc?>)"size="6"/></td>
		
		<td class="TD1"><input type="text" class="form-control" name="mrp_tab[]" value="<?php echo $each_mrp_rate ?>" id="mrp_tab<?php echo $ijkc?>" size="6"/></td>
	
		<td class="TD1"><input type="text" class="form-control txt1" name="sgst[]" value="<?php echo $sgst ?>" id="sgst<?php echo $ijkc?>" size="6"/></td>
        	<td class="TD1"><input type="text" class="form-control txt2" name="cgst[]" value="<?php echo $cgst ?>" id="cgst<?php echo $ijkc?>" size="6"/></td>
            	<td class="TD1"><input type="text" class="form-control " name="vat[]" value="<?php echo $vat ?>" id="vat<?php echo $ijkc?>" size="6"/></td>
		<input type="hidden" name="vatamt[]" class="vatamt" value="<?php echo $vat_amt ?>" id="vatamt<?php echo $ijkc?>" size="6"/>
		<input  type="hidden" name="invid[]" id="invid<?php echo $ijkc?>" class="textbox" value="<?php echo $invid ?>" size="5" readonly>
