...
?>
  ...
  ?>
    ...
    <option value="<?php echo $room_no?>"><?php echo $roomno?></option>
									...
									<div class="form-group">
											...
											<div class="form-group">
	                                          ...
	                                          <input name="adm_fee" type="text" class="form-control"  size="10" value="<?php echo $amt?>"/>
    ...
    Card
    <input type="radio" name="pay_type" value="Paytm" onclick="javascript:card_fun(this.value)" />
    Paytm
	                                        </div>
 ...
 value="<?php echo $ADMIT_DATE;  ?>" readonly placeholder=""/></td><td>
												...
												<input name="time" id="intime1" readonly="readonly"  value="<?php echo $atime; ?>" type="text"  size="20"  class="form-control"  required="required"
 /></td></tr></table>
...
<input type="hidden" name="sno" value="<?php echo $sno;?>"/>		
  ...
  <option value="<?php echo $bedno?>"><?php echo $bed?></option>
										...
										<div class="form-group">
											...
											<input name="mr_charge" type="text" class="form-control"  size="10" value="<?php echo $mrcost?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
