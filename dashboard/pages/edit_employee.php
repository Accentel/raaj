                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											...
											<label class="control-label col-md-2">Gender
                                                ...
                                                <div class="col-md-4">
                                                    <input type="radio" name="gender" value="Male" <?php if( $res['gender']=="Male"){ echo 'checked';} ?>  />&nbsp;&nbsp;Male&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="Female"   <?php if($res['gender']=="Female"){ echo 'checked';} ?>/>&nbsp;&nbsp;Female 
                                            ...
                                            <label class="control-label col-md-2">Salary
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="salary" data-required="1" id="salary" placeholder="Enter Employee Salary" class="form-control" value="<?php  echo $res['salary'];  ?>" /> </div>
