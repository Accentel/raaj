					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                 <header><input type="radio" name="Ortho" value="Ortho" checked>Ortho</header>
...
<?php 
$sql="select distinct a.product_name from phr_purinv_dtl a,phr_prddetails_mast b where b.prd_type_det='Ortho' and a.product_name=b.PRD_NAME ";   // Query to collect records
...
echo "</datalist>";?></datalist>
			...
			<tr><th align="center"><b><u>SNO </u></b></th><th ><b><u>PRODUCT NAME</u></th><th><b><u>SUM </u></th><th><b><u>ABC </u></th></tr> 
			 ...
			 if(isset($_REQUEST['submit'])){
			  ...
			  a.PRODUCT_NAME=b.PRD_NAME and a.product_name ='$d' and b.prd_type_det='Ortho' group by a.PRODUCT_NAME");
