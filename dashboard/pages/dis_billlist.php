...
window.open('discharge_report.php?adv_no='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Discharge Bill List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Discharge Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="dis_bill.php" id="addRow" class="btn btn-info">
															...
															<?php	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																			...
																			<a href="delete_discharge.php?id=<?php echo $res['ADV_ID']; ?>"  class="btn btn-primary btn-xs">
																			<i class="fa fa-trash"></i>
																		</a>
																		<a href="#" onClick="card_pop1('<?php echo $crud->my_simple_crypt($res['ADV_ID'],'e'); ?>')" class="btn btn-primary btn-xs">
