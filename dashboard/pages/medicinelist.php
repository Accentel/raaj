...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
		...
		<table width="70%" align="center" border="1" cellpadding="0" cellspacing="0">	
		  ...
		  <tr><td colspan="2" align="center"><b><u>MEDICINE SHORT LIST </u></b></td>
		  ...
		  <option value="Genral">Genral</option>
			...
			<tr><th align="center"><b><u>SNO </u></b></th><th ><b><u>PRODUCT NAME</u></th><th><b><u>TOTAL QTY </u></th><th>Product Type</th></tr> 
<?php 
if(isset($_POST['sub'])){
	$med=$_POST['med'];
	 $sql="select PRODUCT_NAME,sum(balance_qty) as T_QTY,b.prd_type_det  from phr_purinv_dtl a,phr_prddetails_mast b where b.PRD_NAME=a.PRODUCT_NAME and b.prd_type_det='$med'
 group by a.PRODUCT_NAME";
} else {

 $sql="select PRODUCT_NAME,sum(balance_qty) as T_QTY,b.prd_type_det  from phr_purinv_dtl a,phr_prddetails_mast b where b.PRD_NAME=a.PRODUCT_NAME
 group by a.PRODUCT_NAME";
}
...
<td align="center"><?php echo $row['prd_type_det']; ?></td>
