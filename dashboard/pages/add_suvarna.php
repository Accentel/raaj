                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
								...
								<?php if(isset($_POST['submit'])){
									...
									values('$uid_no','$pname_type','$pname','$age','$sex','$dob','$address','$mobile','$date','$camp_date','New','$height','$weight')");
									if($sq){ print "<script>";
                                	...
                                	<div class="row">
	                                    <div class="col-md-6 col-sm-6">
	                                       ...
	                                       <div class="form-group">
												...
												<input type="radio" name="type" onclick="javascript:location.href='add_suvarna1.php'" value="Existing">Existing
...
<option value="B/O">B/O</option>
                                            ...
                                            <label>Date of Birth :</label>
											 ...
											 <input type="date" name="dob" id="dob"  class="form-control" type="text"  size="20"   />
										...
										<div class="form-group">
                                            <label>Height :</label>
											 ...
											 <input type="text" name="height" id="height"  class="form-control" type="text"  size="20"   />
										...
										<div class="form-group">
	                                            <label>UID No</label>
												 <input type="text" class="form-control" value="<?php echo $max?>" readonly name="uid_no" required id="uid_no"  ></div>
										<div class="form-group">
	                                            <label>Age</label>
										...
										<div class="form-group">
                                            ...
                                            <label>Weight :</label>
											 ...
											 <input type="text" name="weight" id="weight"  class="form-control" type="text"  size="20"   />
	                                            
                                        </div>
										<div class="form-group">
	                                            <label>Camp Date</label>
												<input type="date" name="camp_date" id="camp_date"  class="form-control" type="text"  size="20"   />
