...
if($prdcode != "")	
{
	 $aa="select c.product_code,c.product_name,b.cust_name,a.u_qty,a.value,b.lr_no,batch_no from phr_salent_dtl as a,phr_salent_mast as b,phr_purinv_dtl as c where a.lr_no=b.lr_no and a.inv_id=c.inv_id and b.sal_date between '$sdate' and '$edate' and c.PRODUCT_NAME='$prdcode'";
	$qry1=mysqli_query($link,$aa);
