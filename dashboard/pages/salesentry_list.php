...
<?php include("header.php");?>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<input type="submit" name="sub" class="btn btn-success" value="Submit"></form>
				...
				// from phr_salent_mast as a,phr_salent_dtl as b where a.lr_no=b.lr_no and a.sal_date='$d' order by a.sal_date desc");
				 if(isset($_POST['sub'])){
					 $date=$_POST['date'];
					 $a="select distinct a.lr_no,a.cust_name,a.inv_no,a.total,a.sal_date,a.customer_type
				 from phr_salent_mast as a,phr_salent_dtl as b where a.lr_no=b.lr_no and a.status='' and a.sal_date='$date' order by a.lr_no desc";
				 $sq=mysqli_query($link,$a);
				 } else {
								 $sq=mysqli_query($link,"select distinct a.lr_no,a.cust_name,a.inv_no,a.total,a.sal_date,a.customer_type
				 from phr_salent_mast as a,phr_salent_dtl as b where a.lr_no=b.lr_no and a.status=''  order by a.lr_no desc limit 0,100");								$i=1;
                            ...
                            <?php    $cust_type=$r['customer_type'];  if($cust_type=='c'){ echo "Customer";
																	...
																	<td>
																	    <a href="salesentry_viewlatest.php?lr_no=<?php echo $r['lr_no']?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<!--<a href="view_purchase_invoice.php?id=<?php echo $r['lr_no']?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>-->
                                                                        <a href="medbill.php?lr_id=<?php echo $r['lr_no']?>" target="blank"><img src="../img/print.png"></a>
