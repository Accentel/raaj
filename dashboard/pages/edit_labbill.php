                                        ...
                                        <div class="form-group row">
											...
											<table class=" full-width" >
															...
															?>
															 <tr>
					                                            	<th></th>
																	 <th> <input type="text" name="tname[]" value="<?php echo $t1['testname']; ?>"  id="tname1" placeholder="" class="form-control col-md-4 tname<?php echo $i ?>" onChange="showHint(1)" /></th>
					                                                <th> <input type="text" name="amount[]" value="<?php echo $t1['amount']; ?>" id="amount1" placeholder="" class="form-control col-md-4 txt" /> 
