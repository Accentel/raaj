					                                    ...
					                                    <div class="table-scrollable">
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['name1'] ?></td>
																	...
																	<td>
																		<!--<a href="edit_user.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>-->
																		<a href="../db/delete_user.php?id=<?php echo $res['empcode']; ?>" onclick="confirm('if u want delete a record');" class="btn btn-danger btn-xs">
