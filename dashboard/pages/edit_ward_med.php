...
while ($row=mysqli_fetch_array($r)) {echo  "<option value=\'$row[PRD_NAME]\'/>";}echo '</datalist>';?></div>"; 
    row.appendChild(oCell);
	 ...
	 oCell = document.createElement("TD");
	 	 oCell.innerHTML = "<div align='center' ><input  type='text' name='srate"+Row+"' id='srate"+Row+"'class='form-control'  size='4' onkeyup='val(this.value,"+Row+")' ><input  type='hidden' name='pid"+Row+"' id='pid"+Row+"'  class='form-control'  size='4' > </div>"; 
     row.appendChild(oCell);
	 oCell = document.createElement("TD");
                ...
                <div class="page-content1">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">ADD Ward Medicines</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="ward_med.php">ADD Ward Medicines List</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">ADD Ward Medicines</li>
                            </ol>
                        </div>
                    </div>
				<?php 	
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">ADD Ward Medicines</header>
								...
								<?php 
								$otid=$_REQUEST['id'];
								$t="select * from ip_ward_drug where id='$otid'";
								$uy=mysqli_query($link,$t) or die(mysqli_error($link));
								$uy1=mysqli_fetch_array($uy);
								
								?>
								 <form name="form" method="post" action="update_ward.php" >
 ...
 value="<?php echo $uy1['date1']; ?>" placeholder=""/></td><td>
 	...
 	<div class="form-group">
                                            <label>Gender :</label>
											 ...
											 <input name="sex" id="gen1" value="<?php echo $uy1['gender'];?>" readonly="readonly"  class="form-control" type="text"  size="20"  required="required"
 />
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" value="<?php echo $uy1['age'];?>" name="age" id="age" readonly />
											</td></tr></table>
										...
										<div class="form-group">
												...
												<input type="text" name="rnum" value="<?php echo $uy1['mrno'];?>" class="form-control" onclick="javascript:window.open('patient_popup2.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no')"
 id="regno" readonly /></div>
										 ...
										 <div class="form-group">
                                            <label>Patient Name :</label>
											 ...
											 <input name="pname"  value="<?php echo $uy1['name'];?>" id="patname" readonly="readonly"  class="form-control" type="text"  size="20"  required="required"
 />
									 ...
									 <div class="form-group">
                                            <label>Record No :</label>
											 ...
											 <input name="rec_num" id="rec_num" value="<?php echo $uy1['rec_no'];?>"  class="form-control" type="text"  size="20"  required="required"
 />
...
<div id="purtable" valign="top">
					                                        ...
					                                        <thead>
																...
																<?php
																$uy2=mysqli_query($link,"select * from ip_ward_drug1 where id1='$otid'") or die(mysqli_error($link));
                                	...
                                	<div class="row">
	                                    <div class="col-md-3 col-sm-3">
	                                        <!-- text input -->
	                                            ...
	                                            <input type="text" class="form-control" id="nitem" readonly name="nitem" size="10" value="<?php echo $nit; ?>"   onclick="javasript:noitems()" >
									...
									<div class="form-group">
										...
										<!--<div class="form-group">
											...
											-->
	                                            <input type="hidden"  readonly="readonly"class="form-control" name="nettot"  id="nettot" >
                                       
										<div class="form-group">
                                            <label>Adjustables</label>
	                                            <input type="text" class="form-control" name="adjt"  id="adjt" value="<?php echo $uy1['adjust']; ?>" onkeyup="javascript:adjttotal()" >
                                        </div>
										<div class="form-group">
                                            <label>Rounded</label>
										...
										<div class="form-group">
                                            <label>Total Amount</label>
	                                            <input type="text" readonly="readonly" class="form-control" value="<?php echo $uy1['total_amt']; ?>" name="gtot"  id="gtot" onclick="javascript:adjttotal()" >
                                        </div>
										<div class="form-group">
                                            <label>Paid Amount</label>
	                                            <input type="text" class="form-control" name="paid" value="<?php echo $uy1['paid']; ?>" required id="paid" onkeyup="javascript:krk()" >
                                        </div>
										<div class="form-group">
                                            <label>Balance Amount</label>
	                                            <input type="text" class="form-control" name="bal" value="<?php echo $uy1['bal']; ?>" value="0" readonly="readonly" id="bal" >
                                        </div>
										<script>
function adjttotal(){
var sum=0;
