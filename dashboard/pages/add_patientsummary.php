...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	document.getElementById("date1").value=strar[4];
    }
  }
  str = encodeURIComponent(str);
xmlhttp.open("GET","search217.php?q="+str,true);
xmlhttp.send();
}
...
echo "</datalist>";?></datalist>-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="datee" required  id="date1" class="form-control mrno"  /> 
											...
											<!-- <label class="control-label col-md-2"> Date
                                                ...
                                                <div class="col-md-4">
                                                    <input type="date"    id="date" value="<?php echo date('Y-m-d');?>" class="form-control mrno"  /> 
