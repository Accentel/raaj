            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                     ...
                     if($partic!='' and $sdate1!='1970-01-01' and $edate1!='1970-01-01'){
						 $x1="select * from daily_amount where date(date1) between '$sdate1' and '$edate1' and amnt_type='$partic' and amnt_type!='Pharmacy' order by id desc";
			 ...
			 where   a.amnt_type='In Patient'  and a.bill_num='$bill_num' and  b.bill_num='$bill_num'   and d.id=b.doc_code and
			  b.PAT_REGNO=e.registerno and e.registerno='$bno'";
                           ...
                           <?php } else if($amnt_type=='Lab Bill'){ 
						    $a="select b.pname,b.dname from daily_amount a,bill b,bill1 d
			 where   a.amnt_type='Lab Bill'  and a.bill_num='$bill_num'   and d.cnt='$bill_num' and d.BillNO=b.BillNO";
                           $ssk=mysqli_query($link,$a);
							 $rk=mysqli_fetch_array($ssk);
							 $dname=$rk['dname1'];
                           ...
                           <td align="center"><?php echo $rk['dname']; ?></td>
                           
                           <?php } else {?>
							   <td align="center"><?php echo $pat; ?></td>
						 <td align="center"><?php echo $doc; ?></td><?php }?>
