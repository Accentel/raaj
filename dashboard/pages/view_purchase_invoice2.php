...
$res = mysqli_query($link,"select max(SUP_ID) FROM phr_supplier_mast1");
	IF($res)
	{
...
$lr_id=$_REQUEST['id'];
$sql = mysqli_query($link,"select a.suppl_code,b.suppl_name,b.addr1,pur_type,suppl_inv_no,inv_date,rec_by,total,rec_date,grn,b.city,lr_no,b.paid,b.bal from phr_purinv_mast1 as a,phr_supplier_mast as b where lr_no='$lr_id' and a.suppl_code=b.suppl_code");
if($sql){
...
$sql1 = mysqli_query($link,"select product_code,product_name,packing_type,batch_no,mrp,exp_date,s_qty,s_free,s_rate,discount,value,vat,vat_amt,mfg_date,noitems,cost,manu_by,inv_id,sgst,cgst,tqty,each_pur_rate,each_mrp_rate from phr_purinv_dtl1 where lr_no='$lr_id'");
                ...
                <div class="page-content1">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Panchakarma Purchase Invoice</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="purchase_invoice_list2.php">Purchase Invoice List</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Edit Panchakarma Purchase Invoice</li>
                            </ol>
                        </div>
                    </div>
				<?php 	
				
				 $a="select max(lr_no) from phr_purinv_mast1";
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Panchakarma Purchase Invoice</header>
								 ...
								 <form name="form" method="post" action="insert_purchase_invoice3.php" >
