...
$mrno = $crud->escape_string($_POST['mrno']);
	...
	if($mrno != '') {
		 $ts="update bill set mrno='$mrno',billno='$bno',bdate='$bdate',pname='$pname',age='$age',gender='$gender',dname='$dname',mobile='$mobile',ptype='$ptype',time='$time',tamount='$tamount',discount='$discount',namount='$namount',pamount='$pamount',bamount='$balamount',remarks='$remarks',user='$user',paymenttype='$paymenttype' where id='$id'";
		...
		$id1= $_POST['id1'][$t];
			if($tname!='' and $id1!=''){
				  $ts1="update bill1 set testname='$tname',amount='$amount' where id1='$id1' and mrno='$mrno'";
