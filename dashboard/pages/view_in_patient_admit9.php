...
if($sb=='ALL')
  ...
  $x="select distinct(registerno,patientname,age,gender,doctorname,date,phoneno from patientregister) where pat_type='IP' and 
  date between '$sdate' and '$edate' and opt_type='$sb' ";
