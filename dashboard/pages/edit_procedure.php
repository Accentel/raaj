...
{
$ses=$_SESSION['user'];
include('../db/update_procedure.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Procedure Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Edit Procedure Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="amnt" data-required="1" id="amnt" placeholder="Enter Package Amount" class="form-control " value="<?php echo $res['amnt']; ?>" required/>
													<input name="id" id="id" type="hidden"   value="<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" /> 
													<input name="user" id="user" type="hidden"  class="form-control " value="<?php echo $ses; ?>" /> 
													<span class="required"><?php if(isset($errorpname)){echo $errorpname;} ?></span>
                                            </div>
										 ...
										 <?php }?>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="procedurelist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
