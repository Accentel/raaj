...
function reportxx(){
	...
	window.open('total_collected4.php?sdate='+fdate+'&edate='+tdate+'&partic='+partic1,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>	
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>User Collected Amount Report</header>
                        ...
                        <?php $sq=mysqli_query($link,"select distinct recv_by from daily_amount");
						while($r=mysqli_fetch_array($sq)){
							?>
                            <option value="<?php echo $r['recv_by']?>"><?php echo $r['recv_by']?></option><?php }?>
                            </select>
	                                              </div>
