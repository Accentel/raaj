...
$crud = new Crud();
			...
			$ty="select a.cdate,a.pname,a.age,a.gender,a.complaints,a.clinicalsummary,a.gyncology,a.gremarks,a.pastfamily,a.remarks,a.diagnosis,a.meditation,a.diet,b.cam_name from campus_summary a,campus b  where a.cname=b.id and  a.id='$bno'";
			$t = $crud->getData($ty);
    ...
    <table width="100%">
         ...
         <tr>
         <td style="padding-left:20px;"><div align="left">Campus </div></td>
          ...
          <div style="height:80px;">Clincal Summary:&nbsp;&nbsp;<?php echo $clinicalsummary; ?></div>
				...
				<table width="500">
			<?php	
				 $sql1="SELECT * FROM cvital WHERE id1 = '$bno'";
				$y=$crud->getData($sql1);
				foreach($y as $key=>$row1){
				//while($row1 = mysql_fetch_array($sql1)){
				
				?>	
				<tr><td><?php echo $row1['vname'] ?> </td><td>:</td><td> <?php echo $row1['vvalue']; ?></td></tr>
...
<?php
 $y="select * from cprescription1 where id1='$bno'";
...
<tr><td colspan="2"><img src="../img/raajtop.png" style="width:100%; height:120px;"/>  </td></tr>
            ...
            <?php	
				 $sql2="SELECT * FROM cprocedure WHERE id1 = '$bno'";
			...
			<div style="height:80px;">Diet:&nbsp;&nbsp;<?php echo $diet; ?></div>
			<div style="height:80px;">Meditation :&nbsp;&nbsp;<?php echo $meditation; ?></div>
