    ...
    <div class="page-wrapper">
		...
		<div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <!--<div style="color:red;">Your Softdemo Trail Version is going to be expired<b style="font-size:20px;"> 29-Aug-2019</b>.if any queries please contact(Email:info@accentelsoft.com) </div>-->
                <!-- start mobile menu -->
