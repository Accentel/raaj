...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Supports Bill</u></b></h2></td></tr>
  </THEAD>
	<?php
			//include("config.php");
$crud = new Crud();
			...
			$ty="select * from supportsbill where billno='$bno'";
  ...
  <tr>
         ...
         <tr>
		  ...
		  <tr>
			...
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="45%" style="padding-left:50px;" align="left" ><b><u>Support Name</u></b></td>
					<td width="15%" style="padding-left:50px;" align="left" ><b><u>Batch No</u></b></td>
					<td width="15%" style="padding-left:50px;" align="left" ><b><u>Quantity</u></b></td>
					
					
					<td align="left" style="padding-left:50px;" ><b><u>Amount</u></b></td>
					<td width="15%" style="padding-left:50px;" align="left" ><b><u>Total</u></b></td>
					
					
				</tr>
				
			<?php	
				  $sql1="SELECT sname,amount,size,sqty,total FROM supportsbill1 WHERE  bno = '$bno'";
				$y=$crud->getData($sql1);
				...
				<td style="padding-left:50px;" align="left"><b><?php echo $row1['sname'] ?></b></td>
				<td style="padding-left:50px;" align="left"><b><?php echo $row1['size'] ?></b></td>
				<td style="padding-left:50px;" align="left"><b><?php echo $row1['sqty'] ?></b></td>
				<td  style="padding-left:60px;" align="left"><b><?php echo number_format($row1['amount'],2) ?></b></td>
				<td  style="padding-left:60px;" align="left"><b><?php echo number_format($row1['total'],2) ?></b></td>
				</tr>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href='supportsbilllist.php'><input type="button" value="Close" id="cls" class="butt" onclick="window.close();"/></a></td>
      </tr>
