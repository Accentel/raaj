                ...
                <div class="page-content1">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add  Panchakarma Purchase Invoice</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="purchase_invoice_list2.php"> Panchakarma Purchase Invoice List</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active"> Panchakarma Add Purchase Invoice</li>
                            </ol>
                        </div>
                    </div>
				<?php 	
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
								 ...
								 <form name="form" method="post" action="insert_purchase_invoice2.php" >
									...
									<div class="form-group">
										...
										<div class="form-group">
                                            <label>Adjustables</label>
	                                            <input type="text" class="form-control" name="adjt" required id="adjt" onkeyup="javascript:adjttotal()" >
                                        </div>
										<div class="form-group">
                                            <label>Rounded</label>
	                                            <input type="text" class="form-control" name="round" required id="round" onkeyup="javascript:adjttotal()">
                                        </div>
										<div class="form-group">
