...
<tr><td colspan="2"><img src="../img/raajtop.png" style="width:100%; height:120px;"/>  </td></tr>
			...
			<div style="height:80px;"><b>Food to be avoided :</b>&nbsp;&nbsp;<?php echo $diet; ?></div>
			<div style="height:80px;"><b>Yoga/Exercise :</b>&nbsp;&nbsp;<?php echo $meditation; ?></div>
			<!--<div style="height:80px;"><b>Result:</b>&nbsp;&nbsp;<?php echo $remarks; ?></div>-->
