...
<body>
<form class="form-horizontal" role="form" name="frm1"  id="frm1" novalidate enctype="multipart/form-data"  method="post" action="suvuna_send_sms.php">
<?php
include('../db/connection.php');

?>

	<div> Suvarnaprashan SMS</div>
...
<?php
$p=mysqli_query($link,"select distinct name,contact from suvarna ") or die(mysqli_error($link));
while($p1=mysqli_fetch_array($p)){ ?>
<input type="checkbox" name="chk1[]" id="chk1" value="<?php echo $p1['contact'];?>"  /><?php echo $p1['name']; ?>-<?php echo $p1['contact'] ?><br/>
