...
function reportxx(){
	...
	window.open('total_collected.php?sdate='+fdate+'&edate='+tdate+'&partic='+partic1,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>	
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
					...
					<div class="row">
                        ...
                        <?php $sq=mysql_query("select distinct amnt_type from daily_amount");
