...
?>
	                ...
	                <div id="remove-scroll" class="left-sidemenu">
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                               <?php if($menu24 == "24"){ ?> <li class="nav-item  ">
	                      ...
	                      <!--  <li class="nav-item  ">
	                        ...
	                        <li class="nav-item  ">
	                         ...
	                         <?php if($menu5 == "5"){ ?> <li class="nav-item  ">
	                            <a href="#" class="nav-link nav-toggle"><i class="material-icons">assignment</i>
	                       ...
	                       <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                               <?php if($menu54 == "54"){ ?>  <li class="nav-item  ">
	                       ...
	                       <?php if($menu6 == "6"){ ?>
	                        <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                </li><?php } if($menu604 == "604"){?>
	                                  <li class="nav-item  ">
	                                    <a href="opbilllist.php" class="nav-link "> <span class="title">OP Bill</span>
	                                    </a>
	                                </li><?php } if($menu605 == "605"){?>
									<li class="nav-item  ">
	                       ...
	                       <li class="nav-item  ">
	                        ...
	                        <li class="nav-item  ">
                             ...
                             <?php  if($menu91 == "91"){ ?>   <li class="nav-item  "><a href="uom.php"><span class="title">UOM</span></a></li>
							 <?php } if($menu92 == "92"){ ?>
                     ...
                     <?php } if($menu103 == "103"){ ?> <li class="nav-item  "><a href="salesreturn.php"><span class="title">
 ...
 <li class="nav-item  "><a href="stock_position_report.php"><span class="title">
       ...
       <li class="nav-item  "><a href="profit_report.php"  ><span class="title">
					 Pharmacy Account Summery</span></a></li><?php }?>
	                            </ul>
               ...
               <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                <?php  if($menu1390== "1390"){ ?> <li class="nav-item">
	                                    <a href="emergencycertificatelist.php" class="nav-link ">
	                                        <span class="title">Emergency Certificate</span>
	                                    </a>
	                                </li>
									<?php } if($menu131== "131"){ ?> 
									<li class="nav-item">
	                                ...
	                                </li><?php } if($menu132== "132"){ ?> 
									<li class="nav-item">
	                                    <a href="deathcertificatelist.php" class="nav-link ">
	                                        <span class="title">Death Certificate</span>
	                                    </a>
	                                </li><?php } if($menu133== "133"){ ?> 
									<li class="nav-item">
	                                    <a href="medicalcertificatelist.php" class="nav-link ">
	                                        <span class="title">Medical Certificate</span>
	                                    </a>
	                                </li><?php } if($menu139== "139"){ ?> 
									<li class="nav-item">
	                                    <a href="essentialitycertificatelist.php" class="nav-link ">
	                                        <span class="title">Essentiality Certificate</span>
	                                    </a>
	                                </li>
										<?php } if($menu1391== "1391"){ ?> 								<li class="nav-item">
	                                    <a href="medicalfitnesscertificatelist.php" class="nav-link ">
	                                        <span class="title">Medical Fitness Certificate</span>
	                                    </a>
	                                </li><?php } if($menu134== "134"){ ?> 
									<li class="nav-item">
	                                    <a href="broughtdeadcertificatelist.php" class="nav-link ">
	                                        <span class="title">Brought Dead Certificate</span>
	                                    </a>
										</li><?php } if($menu137== "137"){ ?> 
										<li class="nav-item">
	                                    <a href="medicalcertificateofcauseofdeathlist(4A).php" class="nav-link ">
	                                        <span class="title">Medical Certificate of cause of death list(4A)</span>
	                                    </a>
	                                </li><?php } if($menu136== "136"){ ?> 
									<li class="nav-item">
	                                    <a href="medicalcertificateofcauseofdeathlist.php" class="nav-link ">
	                                        <span class="title">Medical Certificate of cause of death list</span>
	                                    </a>
	                                </li><?php } if($menu135== "135"){ ?> 
									<li class="nav-item">
	                                    <a href="dischargesummary.php" class="nav-link ">
	                                        <span class="title">DISCHARGE SUMMARY</span>
	                                    </a>
	                                </li>
									<?php }?>
