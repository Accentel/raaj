...
//	window.close();
//window.close();
window.self.location='purchase_invoice_list.php';
	}
</script>
</head>
<body>
...
while($row = mysqli_fetch_array($result))
 ...
 $sql1 = mysqli_query($link,"select product_code,product_name,packing_type,batch_no,mrp,exp_date,s_qty,s_free,s_rate,discount,value,vat,vat_amt,mfg_date,noitems,cost,manu_by,sgst,cgst from phr_purinv_dtl where lr_no='$lr_id'");
