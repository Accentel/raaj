...
<td>
					                                    ...
					                                    <div class="table-scrollable">
															...
															if($mobile!=''){
																	...
																	$sq=mysqli_query($link,"select * from patientregister  where phoneno='$mobile' order by reg_id desc");
															}
															
															else if($mr_num!=''){
																$sq=mysqli_query($link,"select * from patientregister  where registerno='$mr_num' order by reg_id desc");
															}else {
					 ...
					 if($pay_type=='OP'){ echo 'Out Patient' ; } else if($pay_type=='IP') { echo 'IN Patient'; }
                             ...
                             ?>                                      </td>
																	...
																	<td><?php echo  $r['age'];?>/<?php echo $r['gender']; ?></td>
																		...
																		<td class="left"><?php echo $r['doctorname'];?></td>
