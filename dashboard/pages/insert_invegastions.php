...
if(isset($_POST['submit'])) {	
	...
	//$check_email = $validation->is_email_valid($_POST['email']);
	 ...
	 if (empty($sname)) {
 $errorsname = "Please Enter Invegastion Name";
	...
	if($sname != '') {
    	...
    	$result = $crud->execute("INSERT INTO 	investigations(iname,user)VALUES('$sname','$user')");
		
		//display success message
		if($result){
			print "<script>";
			print "alert('Record Inserted Successfully ');";
			print "self.location='	investigationlist.php';";
			print "</script>";
		}
	}	
