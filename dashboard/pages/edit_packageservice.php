                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
												...
												<select  name="procedure[]"  id="procedure" class="" multiple  >
												
												 <?php 



		$rst4=mysqli_query($link,"select * from procedures") or die(mysql_error());



		while($rna=mysqli_fetch_array($rst4)){



		?>

 <option value="<?php echo $rn1=$rna['pname']; ?>"<?php echo (isset($rn3) && in_array($rn1, $rn3) ) ? 'selected="selected"' : "" ?>><?php echo $rna['pname']; ?></option>
...
<input name="id" id="id" type="hidden"  class="form-control " value="<?php echo $r1['id']; ?>" /> 													
...
$sname=implode(',',$_POST['procedure']);
 $a="update packageservice  set  pname='$pname',sname='$sname',user='$user' where id='$id'";
...
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.1/jquery-ui.min.js"></script>   
	 ...
	 <script>  $('#procedure').change(function() {
