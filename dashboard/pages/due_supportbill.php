...
{
$ses=$_SESSION['user']; 
include('../db/insert_duesupportbill.php');
include("header.php");?>
<script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Due Supports Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Due Supports Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Due Supports Bill</header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											...
											<table class=" full-width" >
															...
															$yk="select a.id,b.sname,a.amount,c.size FROM supportsbill1 a,supportsize c,supports b WHERE b.id=a.sname and c.id=a.size and a.bno='$bno1' and a.mrno='$mrno'";
															$tu=$crud->getdata($yk);
															$i=100;
															...
															?>
															 <tr>
					                                            	<th></th>
																	 <th> <input type="text" name="sname[]" readonly value="<?php echo $t1['sname']; ?>"   placeholder="" class="form-control col-md-4 tname<?php echo $i ?>"  /></th>
																	  <th> <input type="text" name="size[]" readonly value="<?php echo $t1['size']; ?>"   placeholder="" class="form-control col-md-4 tname<?php echo $i ?>"  /></th>
