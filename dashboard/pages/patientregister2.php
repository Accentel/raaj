...
?>
								...
								<form name="form" method="post" action="../modal/patient_reg_insert3.php">
...
$sq=mysqli_query($link,"select * from  doct_infor where dname1='$doctorname'");
if($sq){
...
$sq=mysqli_query($link,"select * from  referal_doctor where refcode='$ref_doc'");
		...
		<?php }?>
										 ...
										 <div class="form-group">
											...
											<table><tr><td >
												 ...
												 <input name="useee" id="date"  class="form-control"  type="hidden"  size="20"  required="required"
 value="<?php echo $registerno;?>" readonly placeholder=""/></td><td id="ayu" style="display:none;"><strong>S.No: </strong> <?php $sq=mysqli_query($link,"select * from patientregister where opt_type='Ayurvedic'");
...
<option value="Guardian">Guardian</option>
												...
												<input type="text" class="form-control"  name="fname" value="<?php echo $gaurdianname?>" id="fname" required="required" /></td></tr></table>
