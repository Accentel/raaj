...
{
$ses=$_SESSION['user'];
include('../db/insert_supportsize.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="ssize" data-required="1" id="ssize" placeholder="Enter Support Size" class="form-control " value="<?php if(isset($sname)){echo $sname;} ?>" required/>
										   ...
										   <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="amount" data-required="1" id="amount" placeholder="Enter Amount" class="form-control " value="" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="quantity" data-required="1" id="quantity" placeholder="Enter quantity" class="form-control " value="" required/>
