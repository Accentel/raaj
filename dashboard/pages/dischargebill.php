                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post" name="myform">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"  value="" id="mrno" placeholder="Enter MRNO" class="form-control mrno" required onclick="window.open('finalbill_adv.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')"/> 
													 </div>
                                           ...
                                           <label class="control-label col-md-2">Mobile No
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
													...
													<option value="paytm">Paytm</option></option>
													</select>
													</div>
                                           <label class="control-label col-md-2">Pay Amount
                                                    <span class="required"> * </span>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="status"  id="status"  value="Discharge" readonly class="form-control"/> 
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="dischargebilllist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
