...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#FFFFFF">
                   <?php /*?> <tr>
                    ...
                    <!--<tr><tr><td colspan="6"  align="center"><img src="images/majestic_reghead.png"  ></td></tr>-->
					 <tr>
                        <td align="center" style="font-size:24px;" colspan="6">O.T Medicines</td>
                    </tr>
					<div align="center"> 
	...
	<?php
			...
			$sql= mysqli_query($link,"select * from ip_hosp_drug where id='$pno'");
			if($sql)
			{
				$row = mysqli_fetch_array($sql);
 ...
 ?> 
  ...
  <tr>
	...
	<tr><td colspan="4">	
	 ...
	 <?php $sq1=mysqli_query($link,"select * from ip_hosp_drug1 where id1='$pno'");
