...
<input type="submit" name="Sort"></form>
</div>
		...
		<table width="70%" align="center" border="1" cellpadding="0" cellspacing="0">	
		  ...
		  <tr><td colspan="5" align="center"><b><u>TOTAL MEDICINE LIST </u></b></tr>
		 
			<tr><th align="center"><b><u>SNO </u></b></th><th ><b><u>PRODUCT NAME</u></th><th><b><u>PRODUCT TYPE </u></th>
			<th><b><u>MANF.BY </u></th><th><b><u>GENRAL/ORTHO/AYURVEDIC </u></th>
			</tr> 
...
if(isset($_POST["Sort"]))
{
    ...
    $varGender=$_POST['formsort'];
    if($varGender=='All')
    $sql="select * from phr_prddetails_mast  order by PRD_NAME ";
    else
 $sql="select * from phr_prddetails_mast where prd_type_det='$varGender' order by PRD_NAME ";
...
<td class="center">
						   ...
						   <td class="center"><?php echo $row['mani_by'];?></td>
																
																<td class="center"><?php echo $row['prd_type_det'];?></td>




</tr>
				<?php $ki=$i++; }} else{$sql="select * from phr_prddetails_mast  order by PRD_NAME ";
$res=mysqli_query($link,$sql) or die(mysql_error());
$i=1;
while($row=mysqli_fetch_array($res)){
?>
