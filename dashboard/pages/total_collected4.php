...
<table width="100%" cellpadding="0" cellspacing="0"> 
    ...
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header">User Collected Amount  List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
                ...
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                     ...
                     if($partic!='' and $sdate1!='1970-01-01' and $edate1!='1970-01-01'){
						 $x1="select * from daily_amount where date(date1) between '$sdate1' and '$edate1' and recv_by='$partic' and amnt_type!='Pharmacy' order by id desc";
						$qry=mysqli_query($link,$x1);
						
					 } else   if( $sdate1!='1970-01-01' and $edate1!='1970-01-01'){
						$qry=mysqli_query($link,"select * from daily_amount where date(date1) between '$sdate1' and '$edate1' and recv_by='$partic' and amnt_type!='Pharmacy' order by id desc");
						
					 }
					 
					 else   if( $partic!=''){
						  $x="select * from daily_amount where recv_by='$partic' and amnt_type!='Pharmacy' order by id desc";
