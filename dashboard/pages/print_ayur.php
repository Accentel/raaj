...
<div align="center" style="border:#CC6666">
          ...
          <input type="button" value="Print" id="prnt" class="styled-button-2" onclick="prnt();"/> <a href="prescriptionlist_ayur.php"><input type="button" value="Close" id="cls" class="styled-button-2" onclick="closew();"/></a>
								</div>
<div class="book">
    <div class="page">
        <div class="subpage">
...
//include("config.php");
  $id=$_GET['mrno'];
 $a="select * from `prescription_ayur` where id='$id'";
...
<?php
$t=mysqli_query($link,"select * from prescription_ayur1 where id1='$id'") or die(mysqli_error($link));
$i=1;
