                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Vitalsigns Name
                                                    <span class="required"> * </span>
                                                </label>
												
                                                <div class="col-md-5">
                                                    <input type="text" name="pname" data-required="1" id="pname" placeholder="Enter Package Name" class="form-control " value="<?php echo $res['vname']; ?>" required/>
