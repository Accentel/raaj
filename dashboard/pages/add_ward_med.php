                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
								 ...
								 <form name="form" method="post" action="insert_ot1.php" >
...
<?php $dt=date('y');
 ...
 />
										...
										<div class="form-group">
												...
												<input type="text" name="rnum" class="form-control" onclick="javascript:window.open('patient_popup2.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no')"
 ...
 />
									 ...
									 <div class="form-group">
                                            <label>Record No :</label>
											 ...
											 <input name="rec_num" id="rec_num"   class="form-control" type="text"  size="20"  required="required"
 />
...
<div id="purtable" valign="top">
									...
									<div class="form-group">
                                            <label>Sub Total</label>
	                                            <input type="text" class="form-control" readonly  name="total" required id="total" >
                                        </div>
										<!--<div class="form-group">
										...
										<div class="form-group">
                                            <label>Adjustables</label>
	                                            <input type="text" class="form-control" name="adjt"  id="adjt" onkeyup="javascript:adjttotal()" >
                                        </div>
										<div class="form-group">
                                            <label>Rounded</label>
	                                            <input type="text" class="form-control" name="round"  id="round" onkeyup="javascript:adjttotal()">
                                        </div>
										<div class="form-group">
