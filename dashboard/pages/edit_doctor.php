	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
											 ...
											 <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control"  value="<?php echo $r['desc1'];?>"required="required" name="desc" id="desc" >
	                                        </div>
											<div class="form-group">
...
$sql1 = mysqli_query($link,"select * from doctdept where id='$dept'");


	while($row = mysqli_fetch_array($sql1))
	{
?>
<option value="<?php echo $row['id'] ?>"><?php echo $row['doctdeptname'] ?></option>
<?php		
	}
...
$sql2 = mysqli_query($link,"select * from doctdept where id!='$dept'");
