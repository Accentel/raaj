...
$qry=mysqli_query($link,"insert into phr_purinv_mast values($sno,'$supcode','$ptype','$invno','$invdt',now(),'$admin','$recby','$total','$recdt','$grn','$bankname','$chequeno','$date3','$paid','$bal','0')");
...
$sql1=mysqli_query($link,$pp);
 ...
 $mk="insert into phr_purinv_dtl(lr_no,product_name,batch_no,mrp,exp_date,s_qty,s_free,s_rate,value,vat,vat_amt,currentdate,auth_by,mfg_date,noitems,balance_qty,manu_by,sgst,cgst,tqty,each_pur_rate,each_mrp_rate)
