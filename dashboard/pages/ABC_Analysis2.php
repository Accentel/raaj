                            ...
                            <div class="card card-box">
                                <div class="card-head">
                                 <header><input type="radio" name="Ortho" value="Ortho" onclick="javascript:location.href='ABC_Analysis.php'" >Ortho</header>
									...
									<header><input type="radio" name="Ortho" value="Ayurvedic" onclick="javascript:location.href='ABC_Analysis1.php'">Ayurvedic</header>
									<header><input type="radio" name="Ortho"  checked value="Genral">Genral</header>
...
echo "</datalist>";?></datalist>
			...
			<tr><th align="center"><b><u>SNO </u></b></th><th ><b><u>PRODUCT NAME</u></th><th><b><u>SUM </u></th><th><b><u>ABC </u></th></tr> 
			 ...
			 if(isset($_REQUEST['submit'])){
			  ...
			  a.PRODUCT_NAME=b.PRD_NAME and a.product_name ='$d' and b.prd_type_det='Genral' group by a.PRODUCT_NAME");
             ...
             <?php $i++;}
				 ...
				 include("../db/connection.php");
 $ass="select a.product_code,a.product_name,sum(value) from phr_purinv_dtl as a,phr_prddetails_mast as b where a.PRODUCT_NAME=b.PRD_NAME and b.prd_type_det='Genral' group by a.PRODUCT_NAME";
