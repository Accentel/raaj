                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Upload Patients Reports List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Upload Patients Reports List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addpreports.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															$result=mysqli_query($link,"select * from preports1") or die(mysqli_error($link));
															$i=1;
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		<a href="view_preports.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_preports.php?id=<?php echo $res['id']; ?>" onclick="confirm('are you sure delete a record?')" class="btn btn-danger btn-xs">
