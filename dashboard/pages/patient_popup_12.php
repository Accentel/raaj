...
$xx="select a.patientname,c.dname1,c.id ,registerdate,age,a.gender,a.con_type from patientregister as a,ip_pat_admit as b,doct_infor as c where a.registerno='$emp_id' and a.registerno=b.PAT_REGNO and  b.doc_code=c.id";
