                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Suvarnaprashan Calender </div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Edit Suvarnaprashan Calender</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Edit Suvarnaprashan Calender</header>
								...
								<?php if(isset($_POST['submit'])){
									$date=$_POST['date'];
									$id=$_POST['id'];
									$sq=mysqli_query($link,"update  suvarna_cal set `date1`='$date' where id='$id'");
									if($sq){ print "<script>";
                                	...
                                	<div class="row">
	                                    <div class="col-md-6 col-sm-6">
											...
											<div class="form-group">
												...
												<?php $id1=$_GET['reg'];
												$sq=mysqli_query($link,"select * from suvarna_cal where id='$id1'");
