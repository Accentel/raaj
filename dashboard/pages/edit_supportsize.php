...
{
$ses=$_SESSION['user'];
include('../db/update_supportsize.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Support Size </div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Support Size Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Add Support Size</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                <label class="control-label col-md-3">Support Name
                                                ...
                                                <div class="col-md-5">
													...
													<option value="<?php echo $r['id'] ?>" <?php if($r['id']==$r1['stype']){ echo 'selected';} ?>><?php echo $r['sname'] ?></option>				
													<?php }?>
													</select>
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Support Size
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="ssize" data-required="1" id="ssize" placeholder="Enter Support Size" class="form-control " value="<?php echo $r1['size']; ?>" required/>
													<input name="user" id="user" type="hidden"  class="form-control input-height" value="<?php echo $ses; ?>" /> 
													<input name="id" id="id" type="hidden"  class="form-control input-height" value="<?php echo $crud->my_simple_crypt($r1['id'],'e'); ?>" /> 
										   ...
										   <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="amount" data-required="1" id="amount" placeholder="Enter Amount" class="form-control " value="<?php echo $r1['amount']; ?>" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="quantity" data-required="1" id="quantity" placeholder="Enter quantity" class="form-control " value="<?php echo $r1['qty']; ?>"  required/>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="supportsizelist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
