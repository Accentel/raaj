            ...
            <tr>
			 ...
			 where   a.amnt_type='Lab'  and a.bill_num='$bill_num'   and d.cnt='$bill_num' and d.BillNO=b.BillNO";
                           ...
                           <td align="center"><?php echo $rk['DoctorName']; ?></td>
						      ...
						      $a="select  distinct b.PatientName,b.DoctorName from daily_amount a,patientregister b,phr_salent_mast c
			 where   a.amnt_type='Pharmacy'  and a.bill_num='$bill_num'   and c.sr_bill_num='$bill_num' and c.mrnum=b.registerno";
                           $ssk=mysqli_query($link,$a);
							 $rk1=mysqli_fetch_array($ssk);
							 $dname=$rk1['dname1'];
							 $PatientName=$rk1['PatientName'];
							 
							 ?> 
                            <td align="center"><?php echo $PatientName; ?></td>
                           <td align="center"><?php echo $rk1['DoctorName']; ?></td>
                           
                           <?php } else {?>
							   <td align="center"><?php echo $pat; ?></td>
						 <td align="center"><?php echo $ddname; ?></td><?php }?>
                           
                             
                             
                             
                            
                            <td align="center"><?php  if($amnt_type=='Patient Register'){    ?>
							<?php echo $amnt_desc ;} else {
								echo $amnt_type;}
								?></td>
