...
<?php } } ?>
    ...
    <?php if($concession_type!='Paytm'){?> <option value="Paytm">Paytm</option><?php }?>
...
<?php	$sq = mysqli_query($link,"select * from insurance order by ins_name ");
              ...
              <option value="<?php echo $locname?>"><?php echo $locname?></option><?php }?>
                                   ...
                                   <div class="form-group"  id="insu4" style="display:none;">
										...
										<div class="form-group">
	                                            <label>Cancel</label>
	                                            <select  class="form-control" name="cancel"  id="cancel" >
	                                                <option value="">Select</option>
	                                                <option value="Yes">Yes</option>
	                                                <option value="No">No</option>
	                                            </select>
										...
										<div class="form-group">
												...
												<?php if($appoint_type!='Artho'){?><option value="Artho">Artho</option><?php }?>
												<?php if($appoint_type!='Ayurvedic'){?><option value="Ayurvedic">Ayurvedic</option><?php }?>
												</select></div>
