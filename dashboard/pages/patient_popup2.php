...
<?php
	...
	{
		$n = $_REQUEST['name'];
		$sql = mysqli_query($link,"select distinct a.registerno,a.patientname from patientregister a,ip_pat_admit b WHERE  a.patientname='$n' and a.pat_type='IP' and a.registerno=b.PAT_REGNO");
		$rows = mysqli_num_rows($sql);
	}
	else
	{
		$sql = mysqli_query($link,"select distinct a.registerno,a.patientname from patientregister a,ip_pat_admit b WHERE    a.pat_type='IP' and a.registerno=b.PAT_REGNO order by a.registerno desc");
		$rows = mysqli_num_rows($sql);
	}
?>
