...
echo "</datalist>";?></td><td>
					                                    ...
					                                    <div class="table-scrollable">
															...
															$sq=mysqli_query($link,"SELECT distinct a.PAT_ID,a.PAT_NO,b.date,b.patientname,b.age,b.gender,a.ADMIT_DATE,d.dname1,a.BED_NO,a.pat_regno FROM ip_pat_admit as a ,patientregister as b,doct_infor as d where a.PAT_REGNO=b.registerno 
