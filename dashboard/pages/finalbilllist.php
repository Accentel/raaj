					                            ...
					                            <div class="card card-topline-red">
					                                ...
					                                <div class="card-body ">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php	
															$result=mysqli_query($link,"select * from final_bill order by BILL_NO desc");
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td><?php echo $res['PatientMRNo']; ?></td>
																	<td class="left"><?php echo $res['PatientName']; ?></td>
																	<td class="left"><?php echo $res['AdmissionDate']; ?></td>
																	<td class="left"><?php echo $res['DischargeDate']; ?></td>
																	<td>
																		<a href="edit_finalbill.php?id=<?php echo ($res['BILL_NO']); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a  onclick="window.open('print_finalbill.php?id=<?php echo  ($res['BILL_NO']); ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
