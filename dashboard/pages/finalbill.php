...
include('../db/insert_finalbill.php');
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" autocomplete="on" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
										 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="date" name="bdate"    id="bdate" placeholder="Enter Bill Date" class="form-control" value="<?php echo date('Y-m-d'); ?>" required/> 
												</div>
                                    	</div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
													...
													while($r1=mysqli_fetch_array($rt)){
														?>
													<option value="<?php echo $r1['PAT_REGNO']; ?>"><?php echo $r1['PAT_REGNO']."(".$r1['patientname'].")"; ?></option>	
														<?php
													}
													?>
											...
											<label class="control-label col-md-2">Pat No
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="patno1" data-required="1" id="patno1" placeholder="Enter Patient No" class="form-control" value="" />
													
													</div>
                                           	</div>
											<input type="hidden" name="patno" data-required="1" id="patno" placeholder="Enter Patient No" class="form-control" value="" />
                                            ...
                                            <label class="control-label col-md-2">Date of Admission
                                                ...
                                                <div class="col-md-4">
		                                                ...
		                                                <input class="form-control " size="16" placeholder="Date of Admission" type="text" value="" name="doa" id="doa" readonly>
											...
											<div class="form-group row">
                                                <div class="control-label col-md-12" >
												   ...
												   <?php 
												   $i=1;
												   $result=mysqli_query($link,"select * from hospital_tarrif") or die(mysqli_error($link));
												   ...
												   <td><input type="text" name="amount[]" id="amount<?php echo $i; ?>" data-row="<?php echo $i; ?>" value="0" class="txt"/></td>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="concession" id="concession" placeholder=" concession Amount" class="form-control con" value="0"/>
                                                </div>
											...
											<div class="form-group row">													
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="payamount" id="payamount" placeholder=" Pay Amount" class="form-control pay" value="0"/>
                                                </div>
												</div>
												<div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="rbamount" id="rbamount" placeholder=" Remaining Amount" class="form-control" value="0"/>
                                                </div>
