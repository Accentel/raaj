                         ...
                         <table width="93%" class="ruler" id="dataTable" summary="Table of my records" align="center" >
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td>
                                  <input id=\"pname1\" list=\"city1\" name="pname1" onblur="showBatch(this.value,1)" >
<datalist id=\"city1\" >
...
echo "</datalist>";?>
								 ...
								 <?php /*?>  <select name="pname1" id="pname1" onblur="showBatch(this.value,1)" style="width:150px;">
                                  ...
                                  <td><div id='batchdiv1'><select name='bachno1' class='select textbox1' style="width:100px" id='bachno1'><option>Batch</option></select></div></td>
