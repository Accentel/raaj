...
<div align="center" style="border:#CC6666">
		  ...
		  <a href="../pages/asthama.php"><input type="button" value="Close" id="cls" class="styled-button-2" onclick="closew();"/></a>
								</div>
...
$sql=mysqli_query($link,"select * from `asthama` where id='$id'");
      ...
      <tr>
		...
		<table width="100%" border="0" align="left" style="vertical-align:text-top" cellpadding="1" cellspacing="0" >
          ...
          <tr>
			...
			<td ><?php echo $r['pname_type']?>.<?php echo $r['pname'];  ?> </td>
          ...
          <td><?php echo $r['mobile'];  ?></td>
            ...
            <td ><div align="left"><b>Affeted Since :</b> </div></td>
			<td><?php  echo $r['affected'];  ?> </td>
           <td  ><div align="left"><b>Address  : </b></div></td>
          <td><?php echo $r['address'];  ?></td>
            </tr>
			 <tr>
           
            <td ><div align="left"><b>Other Complains :</b> </div></td>
			<td><?php  echo $r['oth_comp'];  ?> </td>
           <td  ><div align="left"><b>Other Medications  : </b></div></td>
          <td><?php echo $r['oth_med'];  ?></td>
            </tr>
