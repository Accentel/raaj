...
$doct=$_POST['rnum'];
$doct1=$_POST['ApplicationDeadline'];
//$doct2=$_POST['tknum'];
...
if($docid)
{
 ...
 `gender`='$sex', `address`='$addr', `phoneno`='$mobile', `registerfee`='$fee', `remarks`='$rmarks', `pat_type`='$type',
  ...
  `con_doc_mob`='$con_doct_mob',`rel_type`='$rel',`cons_fee`='$con_fee',`total`='$total',`pat_type1`='$new', cancel='$cancel', 
...
`insutype`='$ins_type'
  ...
  `auth_by`='$ser',bill_num='$bill_num',opt_type='$appoint_type',date='$reg_date',registerdate='$doct1'
  where reg_id='$id' ";
