...
$a = $_REQUEST['a'];
	  ...
	  //$age = $_REQUEST['age'];
	    ...
	    $n="select * from patientregister  where reg_id='$opno'";
		$qry2= mysqli_query($link,$n) or die(mysqli_error($link));
...
<tr  style=" height:10px;"><td colspan="5"> <h1 align="center" style="font-size:18px;"><b><u>Fee Receipt</u></b></h1></td></tr>
  </THEAD>
   <TBODY>
  <tr>
    <td colspan="5">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FFFFFF">
			...
			/*	$t="select * from organization";
				$sql = mysqli_query($link,$t) or die(mysqli_error($link));
				if($sql)
				{
