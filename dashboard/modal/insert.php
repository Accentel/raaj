...
if (isset($_POST['update_doct'])) {
		...
		`hos_share`='$hos_share',`hos_amount`='$hos_amount',`doct_share`='$doct_share',`doct_amount`='$doct_amount',`total`='$total',
		`wdays`='$wdays',`stime`='$stime',`etime`='$etime',`edays`='$edays',doct_type='$doct_type' where id='$id'"; 
